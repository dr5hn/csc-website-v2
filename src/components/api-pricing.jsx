...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "All states (global) and cities by country endpoints",
      "Inline search filtering and postcode listing/search on all list endpoints",
      "Regions, subregions, ISO 3166, phone dial code, and currency lookup APIs",
  ...
  },
  {
    ...
    features: [
      ...
      "Location autocomplete with ranked, labeled suggestions",
      "Find places near a location, ranked by distance (geospatial search)",
  ...
  },
  {
    ...
    features: [
      ...
      "Data change feed for syncing a local copy of the data",
