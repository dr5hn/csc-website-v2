...
export default function CommunitySection() {
  const { contributorCount, loading } = useGithubContributors();
  
  const displayCount = contributorCount ? `${contributorCount}+` : "50+";
  return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-2xl font-bold text-dark">{displayCount}</span>
            </div>
