...
const features = [
  "Submit corrections & add missing data",
  "Review submissions from other contributors",
  "Track the impact of your contributions",
  "Earn public recognition on our platform",
  "Completely free, forever",
];

export default function UpdateToolPricing() {
  return (
    <div className="rounded-2xl p-[1px] bg-gradient-to-br from-green/20 to-blue/20">
      <div className="rounded-[calc(1rem-1px)] bg-white/80 backdrop-blur-sm border border-light/60 shadow-xl p-8 md:p-12 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
        ...
        <div className="lg:col-span-2">
          <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-green to-blue mb-6 shadow-lg">
            <Heart className="h-8 w-8 text-white" />
          </div>
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-green to-blue bg-clip-text text-transparent">
          ...
          <p className="text-lg text-darkgray mb-8 max-w-2xl">
            Our Update Tool is a community platform. It's completely free to use
            to help us maintain the accuracy of our global database. Your
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              asChild
              className="bg-gradient-to-r from-green to-green/90 hover:from-green/90 hover:to-green text-white px-8 py-4 rounded-xl text-lg font-bold transition-colors inline-flex items-center h-14 shadow-lg transform hover:-translate-y-0.5"
            >
              <Link href="/product/update-tool">
